...
export WORKSPACE_DIR=/data/cat/ws/qizh093f-dino_training
#export TORCH_HOME=$WORKSPACE_DIR/torch_cache          # cache on high-performance storage
#mkdir -p $TORCH_HOME
mkdir -p $WORKSPACE_DIR/output

# Create symbolic link to workspace for easy access
ln -sf $WORKSPACE_DIR $WORK/workspace
